...
@interface SalesDetailController () <UIWebViewDelegate> {
...
@implementation SalesDetailController
...
- (void)viewDidLoad {
    ...
    [self manager];
    _requsetUrl = [NSString stringWithFormat:FNewCarURL,_applicationID];
